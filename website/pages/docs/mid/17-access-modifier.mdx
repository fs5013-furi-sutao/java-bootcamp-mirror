...
<p className="goal">アクセス修飾子の違いが分かり、必要に応じて使い分けることで、
  実装意図を他の開発者に伝えることができるようになること</p>
...
https://github.com/fs5013-furi-sutao/java-bootcamp-answers/tree/main/04.mid/17.access-modifier

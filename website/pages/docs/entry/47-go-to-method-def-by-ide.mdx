---
title: 47. IDE でメソッド定義元へジャンプ
section: 02.入門編
slug: /entry/47-go-to-method-def-by-ide
order: 47
---

# 47. IDE でメソッド定義元へジャンプ

<p className="goal">メソッド呼び出しの実装を見たい時に、コードジャンプ機能を使うと、作業がはかどることを体感してもらう</p>
...
以下の例は、showAllDogs メソッドを Ctrl キーを押しながらホバーする様子です。

![Ctrl キーを押しながらホバーして、メソッド定義の実装を見る](./images/method_ctrl_hover_in_vscode.gif)

Ctrl キーを押しながらホバーすることで、メソッドのスニペット（断片）を見ることができます。
...
https://github.com/fs5013-furi-sutao/java-bootcamp-answers/blob/main/02.entry/47.go-to-method-def-by-ide/src/GoToDefChecker.java

#### DogList.java

https://github.com/fs5013-furi-sutao/java-bootcamp-answers/blob/main/02.entry/47.go-to-method-def-by-ide/src/DogList.java

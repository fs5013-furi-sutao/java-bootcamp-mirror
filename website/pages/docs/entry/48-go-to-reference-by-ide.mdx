---
title: 48. IDE でメソッド参照先へジャンプ
section: 02.入門編
slug: /entry/48-go-to-reference-by-ide
order: 48
---

# 48. IDE でメソッド参照先へジャンプ

<p className="goal">対象のメソッドがどこで使われているのかを把握するのに、
  参照先表示、参照先へ飛ぶ機能を使うと、作業がはかどることを体感してもらう</p>
...
https://github.com/fs5013-furi-sutao/java-bootcamp-answers/blob/main/02.entry/48.go-to-reference-by-ide/src/GoToRefChecker.java

#### DogList.java

https://github.com/fs5013-furi-sutao/java-bootcamp-answers/blob/main/02.entry/48.go-to-reference-by-ide/src/DogList.java
